...
/**
 * ObjectValueBetterThan Node
 * Checks if value at key path is greater than threshold
 * Routes to 'passed' or 'failed' output based on condition
 */
export default class ObjectValueBetterThanNode extends DataFlowNode {
  ...
  public async process(
    ...
    context.logger.info("ObjectValueBetterThan check", {
      path,
      value: numValue,
      threshold,
      orEqual,
